...
#include "nucleus/avalanche/QuadAssemblerEaws.h"
#include "nucleus/avalanche/SchedulerEaws.h"
#include "nucleus/avalanche/SlotLimiterEaws.h"
    ...
    : m_render_window(render_window)
{
    ...
    connect(m_tile_scheduler_eaws.get(), &SchedulerEaws::gpu_eaws_quads_updated, m_render_window, &AbstractRenderWindow::update_gpu_eaws_quads);
    connect(m_tile_scheduler.get(), &Scheduler::gpu_quads_updated, m_render_window, &AbstractRenderWindow::update_requested);
    connect(m_tile_scheduler_eaws.get(), &SchedulerEaws::gpu_eaws_quads_updated, m_render_window, &AbstractRenderWindow::update_requested);
